...
* 64-bit Python 3.6+. We recommend Anaconda3 with numpy 1.14.3 or newer.
* Latest version of TensorFlow: 2.4.0 or newer.
* 1&ndash;8 high-end NVIDIA GPUs with at least 12 GB of GPU memory, NVIDIA drivers, CUDA 11.2 toolkit and cuDNN ???
